from data_utils import MergedMelHarmDataset, MaskedGenCollator
import os
import numpy as np
...
def main():
    ...
    collator = MaskedGenCollator(tokenizer, mask_prob=0.2, bar_id=tokenizer.vocab['<bar>'])
    ...
    save_dir = 'saved_models/gpt_reg/' + tokenizer_name + '/'
